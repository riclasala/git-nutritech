	<div class="row">
		<div class="col-lg-3">
			...
			<div class="list-group">
				<a href="<?php echo base_url(); ?>members/booster" class="list-group-item">Booster Promo</a>
				<a href="<?php echo base_url(); ?>members/specials" class="list-group-item">Specials Promo</a>
				<a href="<?php echo base_url(); ?>members/other_promo" class="list-group-item">Other Promos</a>
			</div>
		</div>
		<!-- /.col-lg-3 -->
